   ...
   public static State save(HttpServletRequest request, Map<String, Object> conf) {
        ...
        try {
            ...
            if (storageState.isSuccess()) {
                //String a=PathFormat.format(conf.get("contextPath") + "/" + EditorController.properties.getUrlPrefix() + "/" + PathFormat.format(savePath));
                //storageState.putInfo("url", PathFormat.format( EditorController.properties.getUrlPrefix() + "/" + PathFormat.format(savePath)));
            	storageState.putInfo("url", EditorController.properties.getUrlPrefixAs()+PathFormat.format(EditorController.properties.getUrlPrefix() + savePath));
